...
class EditEqType extends StatefulWidget {
  final Map<String, dynamic> eqType;

  const EditEqType({super.key, required this.eqType});

  @override
  State<EditEqType> createState() => _EditEqTypeState();
}

class _EditEqTypeState extends State<EditEqType> {
  late TextEditingController _nameController;

  @override
  void initState() {
    super.initState();
    _nameController = TextEditingController(text: widget.eqType['eqt_name']);
  }
  ...
  Future<void> _deleteEqType(String eqtId) async {
    String uri = "${baseUrl}delete_eq_type.php";
    try {
      final response = await http
          .post(Uri.parse(uri), body: {'eqt_id': eqtId})
