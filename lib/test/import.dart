...
class Import_Page extends StatefulWidget {
  const Import_Page({super.key});

  @override
  State<Import_Page> createState() => _Import_PageState();
}

class _Import_PageState extends State<Import_Page> {
  ...
  Future<void> uploadData() async {
    ...
    try {
      String url =
          "http://127.0.0.1/ems_dbcon/import_mt.php"; // Your PHP script URL
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Import File")),
      body: Column(
        children: [
          ElevatedButton(
            onPressed: _pickFile,
          ...
          ElevatedButton(
            onPressed: uploadData, // Call the upload function
